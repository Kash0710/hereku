...
var webstore = new Vue({
    ...
    methods: {
        ...
        addOrderToBackend() {
            fetch('mongodb+srv://tawheed:tawheed@cluster0.hcibapc.mongodb.net/?retryWrites=true&w=majority', {
                method: 'POST',
    ...
    computed: {
        ...
        emptyFields() {
            return (!nameRegExp.test(this.order.Name) || !phoneRegExp.test(this.order.phoneNo))
        },
        ...
        created:
        function () {
            fetch('mongodb+srv://tawheed:tawheed@cluster0.hcibapc.mongodb.net/?retryWrites=true&w=majority').then(
                function (response) {
                    response.json().then(
                        function (json) {
